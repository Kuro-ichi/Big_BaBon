...
class Settings(BaseSettings):
    ...
    JWT_ISSUER: str = "big-babon-api"
    JWT_AUDIENCE: str = "big-babon-clients"
    ...
    QDRANT_DENSE_VECTOR_NAME: str = "dense"         # named vector cho collection hybrid mới
    QDRANT_SPARSE_VECTOR_NAME: str = "sparse"       # sparse lexical vector cho hybrid search
    QDRANT_HYBRID_ENABLED: bool = True
    QDRANT_HYBRID_PREFETCH_MULTIPLIER: int = 4
